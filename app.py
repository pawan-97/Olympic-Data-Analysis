...
if user_menu == 'Overall Analysis':
    ...
    top_contries = helper.fetch_medal_tally(df, 'Overall', 'Overall').head(10)
    fig,ax = plt.subplots()
    ax = sns.barplot(x="total", y="region", data=top_contries, label="region", color="palegreen")
    st.title("Top 10 countries with total medals in Olympic games")
    st.pyplot(fig)
